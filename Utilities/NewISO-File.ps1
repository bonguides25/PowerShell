$Source = Read-Host "Enter the path of a file or folder you want to add to ISO file"
$Source = ($Source).trim('"')
$Source = ($Source).trim("'")
...
{  
 ...
 #>
  ...
  [CmdletBinding(DefaultParameterSetName='Source')]Param( 
    [parameter(Position=1,Mandatory=$false,ValueFromPipeline=$true, ParameterSetName='Source')]$Source,  
