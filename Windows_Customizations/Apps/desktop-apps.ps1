...
Start-Process -FilePath msiexec.exe -ArgumentList "/i https://www.7-zip.org/a/7z2501-x64.msi /qn" -Wait
msiexec.exe /i https://download-installer.cdn.mozilla.net/pub/firefox/releases/142.0.1/win64/en-US/Firefox%20Setup%20142.0.1.msi /qn
