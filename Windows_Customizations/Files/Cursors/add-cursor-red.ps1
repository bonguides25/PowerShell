...
Invoke-WebRequest -Uri 'https://github.com/bonguides25/PowerShell/raw/refs/heads/main/Windows_Customizations/Files/Cursors/RedNormal.cur' -OutFile "$cursors_path\RedNormal.cur"
$Cursors = @{
    "Arrow"          = "$cursors_path\RedNormal.cur"
    "Help"           = "$cursors_path\RedNormal.cur"
    "AppStarting"    = "$cursors_path\RedNormal.cur"
    "Wait"           = "$cursors_path\RedNormal.cur"
    "Crosshair"      = "$cursors_path\RedNormal.cur"
    "IBeam"          = "$cursors_path\RedNormal.cur"
    "NWPen"          = "$cursors_path\RedNormal.cur"
    "No"             = "$cursors_path\RedNormal.cur"
    ...
    "Hand"           = "$cursors_path\RedNormal.cur"
}
